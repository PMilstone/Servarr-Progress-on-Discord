...
"%POWERSHELL%" -Command "$WShell = New-Object -ComObject WScript.Shell; $Startup = $WShell.SpecialFolders('Startup'); if (Test-Path ($Startup + '\Servarr-Progress-on-Discord.lnk')) { exit 0 } else { exit 1 }" >nul 2>&1
